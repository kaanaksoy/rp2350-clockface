...
void ClockScreen::init_clock_hands() {
  ...
  hours_hand = lv_img_create(parent);
  ...
  minutes_hand = lv_img_create(parent);
  ...
  seconds_hand = lv_img_create(parent);
...
void ClockScreen::init_arc_complications() {
  ...
  particulate_matter_arc = lv_arc_create(parent);
...
void ClockScreen::init(lv_obj_t *parent, clock_time_t time) {
